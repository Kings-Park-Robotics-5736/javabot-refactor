...
public class ElevatorMechanismCTRE extends ElevatorMechanism {
     ...
     */
    public ElevatorMechanismCTRE(String name,
            Byte primaryMotorId,
        ...
        configs.MotionMagic.MotionMagicCruiseVelocity = motionMagicConstants.kMaxVelocity;
                ...
                new SysIdRoutine.Mechanism(
                        ...
                        log -> {
                            log.motor(("Elevator"))
                                    ...
                                    .angularPosition(
                                            m_distance.mut_replace(m_leader.getPosition().refresh().getValueAsDouble(),
                                                    Rotations))
                                    .angularVelocity(
